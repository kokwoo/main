...
public class TempDisplay {
	...
	public void printSearchResults() {
		...
		if (wordFoundLines.isEmpty()) {
			...
			for (int i = 0; i < wordFoundLines.size(); i++) {
				System.out.println(wordFoundLines.get(i));
			}
		}
	}
	 ...
	 * ArrayList<FloatingTask> _floatingTasks) { date = new
	 * CurrentDateAndTime();
	 * 
	 * events = new ArrayList<Event>(); tasks = new ArrayList<Task>();
	 * floatingTasks = new ArrayList<FloatingTask>();
	 * 
	 * eventsToday = new ArrayList<Event>(); upcomingEvents = new
	 * ArrayList<Event>(); pastEvents = new ArrayList<Event>();
	 * 
	 * tasksToday = new ArrayList<Task>(); upcomingTasks = new
	 * ArrayList<Task>(); missedTasks = new ArrayList<Task>();
	 * 
	 * undoneTasks = new ArrayList<Task>(); undoneFloatingTasks = new
	 * ArrayList<FloatingTask>();
	 * 
	 * doneTasks = new ArrayList<Task>(); doneFloatingTasks = new
	 * ArrayList<FloatingTask>();
	 * 
	 * events = _events; tasks = _tasks; floatingTasks = _floatingTasks;
	 * 
	 * splitsEvents(); 
	 * // splitting (floating) done and undone tasks
	 * splitFtasks(); 
